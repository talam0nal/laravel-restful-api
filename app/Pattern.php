...
class Pattern {
	...
	# but SHOULD be one syllable. May be incomplete; do not modify. (+1)
	...
	# and the base rules but SHOULD be two syllables. May be incomplete; do not modify. (+2)
	...
	# Single syllable prefixes and suffixes. May be incomplete; do not modify. (+1)
